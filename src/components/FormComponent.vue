    ...
    <form @submit.prevent="submitForm">
        ...
        <div class="form-control">
            ...
            <select v-model="employee.department">
                ...
                <option value="ฝ่ายขาย">โปรแกรมเมอร์</option>
                <option value="ฝ่ายขาย">ทนาย</option>
                <option value="ฝ่ายขาย">ตำรวจ</option>
                <option value="ฝ่ายขาย">พนักงานบัญชี</option>
            </select>
        </div>
        <div class="form-control">
            <h2>เพศ</h2>
